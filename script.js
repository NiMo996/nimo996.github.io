...
const messages = [ { condition: isMorning, message: 'Good Morning!' },{ condition: isAfternoon, message: 'Good Afternoon!' },{ condition: isEvening, message: 'Good Evening!' }]
...
//get the todos from local storage or set to an empty array
